...
class Utils {
  ...
  static void showSuccessSnackBar(String? text) {
    if (text == null) return;
    SnackBar snackBar = SnackBar(content: Text(text), behavior: SnackBarBehavior.floating);
    messengerKey.currentState!
      ..removeCurrentSnackBar()
      ..showSnackBar(snackBar);
  }
  ...
  static void showNotificatonSnackBar(String? title) {
    ...
    SnackBar snackBar = SnackBar(content: Text(title), behavior: SnackBarBehavior.floating);
    messengerKey.currentState!
      ..removeCurrentSnackBar()
      ..showSnackBar(snackBar);
  }
