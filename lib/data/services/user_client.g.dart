...
class _UserClient implements UserClient {
  ...
  @override
  Future<HttpResponse<DefaultResponse<dynamic>>> getUser({
    int? userId,
    String? email,
    int? pageSize,
    int? page,
  ...
  @override
  Future<HttpResponse<DefaultResponse<dynamic>>> createUser(
...
String _$userClientHash() => r'f39b5914ba32170c94bb2430d00bb31043944c75';
