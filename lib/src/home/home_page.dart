  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(settings.themeMode.localize(context), style: Theme.of(context).textTheme.headlineMedium),
            TextButton.icon(
              onPressed: () => Future.sync(
                () => ref
                    .read(settingsProvider.notifier)
                    .setLocale(
                      settings.locale.languageCode == 'en' ? const Locale('es') : const Locale('en'),
                    ),
              ),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        child: Icon(settings.themeMode.isDark ? Icons.light_mode : Icons.dark_mode),
      ),
    );
  }
}
